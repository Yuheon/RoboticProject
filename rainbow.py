...
class RainbowAgent:
    ...
    def train(self, num_frames: int, plotting_interval: int = 200):
        ...
        for frame_idx in range(1, num_frames + 1):
            action = self.select_action(torch.tensor(state, dtype=torch.float32).reshape(1, 1, -1))
            ...
            if frame_idx % plotting_interval == 0:
                ...
                torch.save(self.dqn.state_dict(), f"rainbow_lv{args.env_level}_rp{args.replay_size}_fr{frame_idx}.pt")
...
def train(args):
    ...
    # train
    agent = RainbowAgent(env, memory_size, batch_size, target_update, 777, lr=args.lr)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--replay_size", type=int, default=50000, help="")
