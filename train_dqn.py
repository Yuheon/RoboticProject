...
class DQNTraining():
    def __init__(self, args, is_traning=True):
    ...
    def train(self, args):
        ...
        env = PathPlanningEnv(args.level, args.agent_jump)
        
        for e_i in range(args.n_episodes):
            # 환경과 상태 초기화
            ...
            if e_i % 50 == 0:
                torch.save(self.policy_net.state_dict(), f"dqn_ep{e_i}.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--replay_size", type=int, default=10000, help="discount factor")
    # exploration
